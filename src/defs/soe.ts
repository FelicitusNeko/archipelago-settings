...
SoESettings.push(
  Object.seal<ArchipelagoBooleanSetting>({
    ...
    description:
      "Fixes cheats left in by the developers (excluding Desert Skip).",
    default: true,
  })
);
SoESettings.push(
...
SoESettings.push(
  Object.seal<ArchipelagoBooleanSetting>({
    ...
    description:
      "Replaces offensive spells by Turd Balls with varying strength, and weakens weapons.",
    default: false,
  })
);
...
const SoEItems: ArchipelagoItem[] = [
  { name: "Acid Rain" },
  { name: "Atlas" },
  { name: "Barrier" },
  { name: "Call Up" },
  ...
  { name: "Bronze Spear" },
  { name: "Lance (Weapon)" },
  { name: "Progressive breast / Dino Skin / Talons" },
  { name: "Bazooka+Shells / Shining Armor / 5k Gold" },
  ...
  { name: "30 Cryo Blast" },
  { name: "3 Meteorite" },
  { name: "30 Particle Bombs or Nectar?" },
  { name: "30 Thunderballs" },
  { name: "Atom Smasher" },
  { name: "4 Dry Ice" },
];

const SoELocations: ArchipelagoLocation[] = [
  { name: "Acid Rain" },
  { name: "Atlas" },
  { name: "Barrier" },
  { name: "Call Up" },
