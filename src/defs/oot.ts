...
const OoTItems: ArchipelagoItem[] = [
  ...
  { name: "Heart Container (Boss)", readableName: "Boss Heart Container", max: 8 },
  { name: "Piece of Heart", max: 36 },
  { name: "Piece of Heart (Treasure Chest Game)" },
  { name: "Recovery Heart", max: 0 },
  { name: "Weird Egg" },
  { name: "Milk" },
  { name: "Gold Skulltula Token", max: 100 },
  ...
  { name: "Ice Arrows" },
  { name: "Light Arrows" },
  { name: "Rupee (1)", max: 100 },
  { name: "Rupees (5)", max: 100 },
  { name: "Rupees (20)", max: 50 },
  { name: "Rupees (50)", max: 20 },
  { name: "Rupees (200)", max: 5 },
  { name: "Rupee (Treasure Chest Game)" },
  { name: "Progressive Wallet", max: 3 },
  { name: "Deku Stick (1)" },
  { name: "Deku Stick Capacity", max: 2 },
  { name: "Slingshot" },
  { name: "Deku Nuts (5)" },
  { name: "Deku Nuts (10)" },
  { name: "Deku Seeds (30)" },
  { name: "Deku Nut Capacity", max: 2 },
  { name: "Bomb Bag" },
  { name: "Bombs (5)" },
  { name: "Bombs (10)" },
  { name: "Bombs (20)" },
  ...
  { name: "Bombchus (10)" },
  { name: "Bombchus (20)" },
  { name: "Progressive Hookshot", max: 2 },
  { name: "Progressive Strength Upgrade", max: 3 },
  { name: "Progressive Scale", max: 2 },
  { name: "Magic Mirror" },
  { name: "Lens of Truth" },
  { name: "Bottle" },
  ...[
  ...
  { name: "Triforce Piece", max: 0, dependsOn: { triforce_hunt: [true] } },
  { name: "Ice Trap", max: 0 },
];
